...
const MyState = () => {
  /*
    ...
    - state값은 직접 변경할 수 없고 반드시 setter를 통해서만  변경가능하다.
    - useState() 함수에 전달하는 값은  state 값에 대한 초기 값이다.
    */
  ...
  const onMyNameChange = (e) => {
    //e.curruntTarget은 jQuery의 $(this)에 해당됨
    ...
    <div>
      ...
      <diiv>
        ...
        <input
          ...
          value={myPoint}
          step="1"
          // 이벤트 핸들러를 익명화살표 함수형식으로 정의한 경우
          onChange={(e) => {
            //자기스스로의 입력값을 myName이라는 state값에 반영함
